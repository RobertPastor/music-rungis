    ...
    DayPilotMonth.Month = function(placeholder) {
        ...
        */
        ...
        this.drawCell = function(x, y, table) {
            ...
            var date = d.getDay();
            if (date === 1) {
            	// Robert - first day of a month - in french 1er
                day.innerHTML = date + "er " + resolved.locale().monthNames[d.getMonth()];
                // Robert - 22 may 2016
                if (this._isBankHolidays(d)) {
                	day.innerHTML = this._getBankHolidaysName(d);
                }
            }
            else {
                day.innerHTML = date;
